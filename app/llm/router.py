...
_REASONING_LINE_PATTERNS = [
    ...
    re.compile(r"^The\s+user\s+(wants|asked|is\s+asking)\b", re.IGNORECASE),
    re.compile(r"^Let\s+me\s+(analyze|check|look|review|consider|think|see)\b", re.IGNORECASE),
    re.compile(r"^I\s+(need|will|should|can|have|am|must)\b", re.IGNORECASE),
    re.compile(r"^I\s+need\s+to\b", re.IGNORECASE),
    re.compile(r"^Looking\s+at\b", re.IGNORECASE),
    re.compile(r"^Now,?\s+(the\s+)?(client|user|incoming)\b", re.IGNORECASE),
    re.compile(r"^However,?\s+this\s+seems", re.IGNORECASE),
    re.compile(r"^Wait,?\s+(there's|this|the)", re.IGNORECASE),
    re.compile(r"^Given\s+the\s+style", re.IGNORECASE),
    re.compile(r"^But\s+wait", re.IGNORECASE),
    re.compile(r"^Actually,?\s+looking", re.IGNORECASE),
    re.compile(r"^Key\s+elements", re.IGNORECASE),
    re.compile(r"^Since\s+the\s+user", re.IGNORECASE),
    re.compile(r"^Daniel's\s+response", re.IGNORECASE),
    re.compile(r"^Draft\s+structure", re.IGNORECASE),
    re.compile(r"^However,?\s+this", re.IGNORECASE),
    re.compile(r"^Reprenons\b", re.IGNORECASE),
    re.compile(r"^Vérifions\b", re.IGNORECASE),
    re.compile(r"^Format\s+de\s+sortie", re.IGNORECASE),
    re.compile(r"^Mais\s+attend", re.IGNORECASE),
    re.compile(r"^En\s+fait", re.IGNORECASE),
    re.compile(r"^Pour\s+\".*?\"\s*:", re.IGNORECASE),  # Pour "Geachte" au début...
    re.compile(r"^Pour\s+\".*?\"\s+en", re.IGNORECASE),
    re.compile(r"^Pour\s+\".*?\"\s+est", re.IGNORECASE),
    re.compile(r"^Pour\s+\".*?\"\s+=\s+", re.IGNORECASE),
    re.compile(r"^Structure\s+de\s+la\s+réponse", re.IGNORECASE),
    re.compile(r"^Contexte\s+(du|from)\s+vault", re.IGNORECASE),
    re.compile(r"^Style\s+guide", re.IGNORECASE),
    re.compile(r"^Incoming\s+email", re.IGNORECASE),
