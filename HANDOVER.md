...
> **Dernière mise à jour**: 2026-07-02 · **Version courante**: v1.30.0.8 · **Déployé sur** : `detective.digitalhs.biz`
...
État au **2026-07-02** : **v1.30.0.8** livrée et déployée en prod (**459 tests verts**, 2 pre-existing failures sur `test_mission_dated_draft.py` non liées — date 02/07 stale). **Dernières versions** (sprint en cours) :
