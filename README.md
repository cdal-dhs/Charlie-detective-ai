...
| Version | Source unique `app/_version.py` (`VERSION = "1.22.20"`) — `pyproject.toml` figé en 1.9.5 (volontaire) |
...
✅ **Production active** — `detective.digitalhs.biz` — **v1.22.20**
...
Version source de vérité : **`app/_version.py`** (`VERSION = "1.22.20"`).
