...
| Version | Source unique `app/_version.py` (`VERSION = "1.23.0"`) — `pyproject.toml` figé en 1.9.5 (volontaire) |
...
✅ **Production active** — `detective.digitalhs.biz` — **v1.23.0**
